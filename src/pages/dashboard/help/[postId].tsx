...
const DashboardHelpPostDetails: NextPage = () => {
    ...
    <>
      ...
      >
        <Container maxWidth="md">
          <NextLink href="/dashboard/help" passHref legacyBehavior>
            <Button
              component="a"
...
DashboardHelpPostDetails.getLayout = (page) => (
  <AuthGuard>
    <DashboardLayout>{page}</DashboardLayout>
  </AuthGuard>
);

export default DashboardHelpPostDetails;
